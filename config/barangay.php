...
return [
    ...
    */
    ...
    'facebook' => [
        'name' => env('BARANGAY_FACEBOOK_NAME', 'Barangay San Jose Talibon'),
        'url'  => env('BARANGAY_FACEBOOK_URL', 'BARANGAY_FACEBOOK_URL=https://www.facebook.com/barangay.sanjose.3766'),
    ],
