...
.signature .role{color:#000000;font-size:15px;text-align:center}
...
@media(max-width:900px){
    ...
    .signature{align-items:center;text-align:center;width:100%}
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    <span class="value" style="color: #000000; text-transform: uppercase; padding-right: 20px;">
                        {{ $punongBarangay ?? 'Hon. Josefina C. Gurrea' }}
                        <span class="sub" style="text-align: center; padding-right: 20px;">Punong Barangay</span>
                    </span>
                </div>
            </div>
